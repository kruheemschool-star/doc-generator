...
[
  {
    ...
    "answer": "ข. [คำตอบที่ถูกต้อง] (ระบุตัวเลือก ก/ข/ค/ง ที่ถูกต้อง)",
    "solution": "**คำตอบ: ข้อ ข.** เฉลย/วิธีทำ + อธิบายว่าทำไมตัวเลือกอื่นผิด (ถ้ามีในต้นฉบับ หรือเว้นว่างไว้)",
    "space": "medium"
  }
]
**สำคัญ:**
...
- **"answer" ต้องระบุ ก./ข./ค./ง.** ตามตัวเลือกที่ถูกต้อง
- หากต้นฉบับไม่มีเฉลย ให้ใส่ "solution" เป็น ""
- แนบเอกสาร/รูปภาพโจทย์ไปพร้อมกับคำสั่งนี้ใน Gemini`;
            }
...
> นำคำตอบที่ถูกต้องจากขั้นตอนที่ 1 และตัวเลือกหลอกทั้ง 3 ตัวจากขั้นตอนที่ 2 มา **สุ่มวาง** ในตัวเลือก ก., ข., ค., ง. (ไม่จำเป็นต้องให้คำตอบที่ถูกอยู่ข้อ ก. เสมอ ให้กระจายสุ่มทุกตำแหน่ง)
...
> 3. "answer" ระบุตัวเลือกที่ถูกชัดเจน เช่น "ข. $-a^n$"
> 4. "solution" ต้องขึ้นต้นด้วย **"คำตอบ: ข้อ [ก/ข/ค/ง]"** แสดงวิธีทำทีละบรรทัด และ **อธิบายว่าทำไมตัวเลือกอื่นถึงผิด**
...
[
  {
    ...
    "solution": "**คำตอบ: ข้อ ข.** [แสดงวิธีทำทีละขั้นตอน + อธิบายว่าทำไมตัวเลือกอื่นผิด] ${solutionTemplateSuffix}",
    "space": "medium"
  }
]
**สำคัญ:**
...
[
  {
    "question": "โจทย์ (ใช้ LaTeX สำหรับสมการ)",
    "options": ["เนื้อหาตัวเลือกที่ 1", "เนื้อหาตัวเลือกที่ 2", "เนื้อหาตัวเลือกที่ 3", "เนื้อหาตัวเลือกที่ 4"],
    "answer": "ค. [คำตอบที่ถูกต้อง] (ระบุตัวเลือก ก/ข/ค/ง ที่ถูกต้อง สุ่มตำแหน่ง)",
    "solution": "**คำตอบ: ข้อ ค.** [แสดงวิธีทำทีละขั้นตอน + อธิบายว่าทำไมตัวเลือกอื่นผิด] ${solutionTemplateSuffix}",
