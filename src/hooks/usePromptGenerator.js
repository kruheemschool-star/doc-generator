...
`;
        ...
        if (solLevel === 'detailed' || solLevel === 'very_long') {
            solutionTypeDesc = "เฉลยแบบละเอียดทุกขั้นตอน: ต้องมีส่วนประกอบ 1) **หลักการคิด (Principle)** — อธิบายว่าโจทย์นี้ใช้หลักการอะไร 2) **วิธีทำอย่างละเอียดเป็นขั้นตอน** — อธิบายทุกบรรทัดว่าทำอะไรและทำไม 3) **สรุปจุดที่ควรระวัง (Precautions)** 4) **Danger Zone (จุดที่ผิดบ่อย)** — **ความยาวเฉลยรวมทั้งหมดประมาณ 500 คำ**";
            ...
            solutionTypeDesc = "เฉลยแบบปานกลาง: แสดงวิธีทำเป็นขั้นตอนชัดเจน พร้อมอธิบายเหตุผลสำคัญในแต่ละขั้นตอน ไม่ต้องมีหลักการคิดหรือ Danger Zone แยก แต่ถ้ามีจุดสำคัญให้แทรกไว้ในวิธีทำ — **ความยาวเฉลยรวมประมาณ 250 คำ**";
            ...
            solutionTypeDesc = "เฉลยแบบสั้น: ให้เน้นการเฉลยแสดงวิธีทำอย่างเดียว ไม่ต้องพูดถึงหลักการคิดหรือข้อควรระวัง — **ความยาวเฉลยรวมประมาณ 150 คำ**";
