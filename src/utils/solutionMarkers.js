...
// optional blockquote `>`, heading `#`, list number, or bold `**` — with one of
// the Thai markers below, and runs to the END of the block. Everything above is
// the problem/content shown to students; the region below is the worked answer.
